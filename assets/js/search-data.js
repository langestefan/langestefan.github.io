...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "Repositories I have contributed to or am actively working on.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          title: 'Launch of my new personal website!',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/langestefan", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
